...
export default function Tools() {
  ...
  return (
    <div className="absolute bottom-4 z-50 flex h-fit w-fit items-center justify-center gap-1 rounded-lg bg-primary-foreground shadow-md ring-1 ring-foreground/10 max-md:inset-x-0 max-md:mx-auto md:left-4 md:top-4 md:flex-col">
...
export function Options() {
  ...
  return (
    <div className="relative z-20 mx-auto flex h-fit w-fit items-center justify-center gap-1 rounded-lg">
